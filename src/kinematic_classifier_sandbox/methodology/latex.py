    ...
    *,
    ...
    toy_problem_rows = [
        ...
        },
        {
            ...
            "purpose": "Show a non-injective measurement case where the posterior is genuinely multimodal",
            "classes": "positive-position branch vs negative-position branch under absolute-range sensing",
            "features": "particle evidence compared directly against a 1D grid oracle and a single-Gaussian projection",
            "classifiers": "particle_filter_bank",
            "priors": "uniform",
            "what_it_proves": "Particle evidence preserves multimodal posterior structure materially better than a single-Gaussian projection when the measurement is non-injective.",
            "key_artifacts": "pf_abs_range_multimodal_oracle_v1, advanced_filter_comparison_v1",
            "known_limitations": "Witness is targeted and does not replace simpler rungs on linear-Gaussian regimes.",
        },
        {
        ...
        },
        {
            ...
            "key_artifacts": "rbpf_v1, advanced_filter_comparison_v1/pf_vs_rbpf_frontier_summary.csv",
    ...
    algorithm_ladder_rows = [
        ...
        },
        {
            ...
            "failure_mode_addressed": "Single-Gaussian projections collapse multimodal posterior structure or miss mean-reverting stochastic dynamics",
            "toy_problem_evidence": "pf_abs_range_multimodal_oracle_v1, ornstein_uhlenbeck_witness_v1",
        ...
        },
        {
            ...
            "toy_problem_evidence": "rbpf_v1, advanced_filter_comparison_v1/pf_vs_rbpf_frontier_summary.csv",
            "promotion_status": "promote",
        },
    ]
    algorithm_lane_rows = [
