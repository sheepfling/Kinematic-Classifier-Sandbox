...
def default_exploration_backend_specs() -> tuple[ExplorationBackendSpec, ...]:
    return (
        ...
        ExplorationBackendSpec(
            ...
            notes="Sequential-control baseline for witnesses where control timing matters rather than static parameter proposals.",
        ),
        ExplorationBackendSpec(
            backend_id="sac",
            display_name="SAC",
            ...
            notes="Off-policy continuous-control candidate for better sample reuse than PPO.",
        ),
        ExplorationBackendSpec(
            backend_id="td3",
            display_name="TD3",
            ...
            lift_ready_3d=True,
            benchmark_priority="research_candidate",
            notes="Alternative continuous-control policy search lane tracked with SAC rather than making PPO the only advanced generator.",
        ),
        ExplorationBackendSpec(
