...
CLAIMS: tuple[ClaimEvidence, ...] = (
    ClaimEvidence(
        ...
        test_paths=("tests/test_corpus_adequacy_audit.py", "tests/test_class_validity.py"),
        current_status="strong",
        limitations="Current generated corpora can still fail some adequacy gates.",
        next_work="Harden closed-loop corpus search and regenerate selected corpora.",
    ...
    ClaimEvidence(
        ...
        test_paths=("tests/test_feature_analysis.py", "tests/test_pca_analysis.py"),
        current_status="strong",
        limitations="Feature independence assumptions still require care.",
        next_work="Add explicit dependence warnings to every cumulative/windowed evidence report.",
    ...
    ClaimEvidence(
        ...
        artifact_paths=(
            ...
            "artifacts/showcase/plots/prior_sensitivity.png",
        ),
        test_paths=("tests/test_prior_sensitivity_analysis.py",),
        current_status="strong",
    ...
    ClaimEvidence(
        ...
        test_paths=("tests/test_generic_inference_contract.py", "tests/test_generic_classification_evidence_proof.py"),
        current_status="strong",
        limitations="Some metrics are not exposed uniformly by every rung.",
        next_work="Normalize optional metric exports across rungs.",
    ...
    ClaimEvidence(
        ...
        test_paths=("tests/test_pointwise_baseline.py", "tests/test_windowed_baseline.py", "tests/test_kalman_filter_bank.py"),
        current_status="strong",
    ...
    ClaimEvidence(
        ...
        test_paths=("tests/test_generic_corpus_exploration.py", "tests/test_selected_generated_corpus.py"),
        current_status="v1 complete",
        limitations="Closed-loop QD hardening remains future work.",
        next_work="Connect QD archive selection to automated adequacy reruns.",
    ...
    ClaimEvidence(
        ...
        test_paths=("tests/test_advanced_filter_evaluation.py", "tests/test_imm_filter.py", "tests/test_particle_filter.py", "tests/test_rbpf.py"),
    ...
    ClaimEvidence(
        ...
        test_paths=("tests/test_dimensional_lift_audit.py", "tests/test_backend_adapter_proof.py"),
        current_status="architectural",
        limitations="3D adapters and feature families are not complete.",
        next_work="Prioritize vector backends, feature families, and dynamics audits.",
...
ARTIFACT_MANIFEST: tuple[ArtifactManifestEntry, ...] = (
    ArtifactManifestEntry("artifacts/corpus_objectives/objective_validation_report.md", "src/kinematic_classifier_sandbox/corpus_objectives.py", ("experiments/corpus_objectives/common_1d_corpus_objectives.yaml",), "What corpus objectives are valid enough to drive generation?", "C06", "implemented", "Objectives still need richer 3D geometry and dynamics terms."),
    ArtifactManifestEntry("artifacts/candidate_generation/generated_candidates.csv", "src/kinematic_classifier_sandbox/candidate_generation.py", ("artifacts/corpus_objectives/objective_validation_report.md",), "Which candidate parameterizations were generated?", "C06", "implemented", "Candidate diversity is limited by current 1D sampler families."),
    ArtifactManifestEntry("artifacts/generic_corpus_exploration/candidate_scores.csv", "src/kinematic_classifier_sandbox/generic_corpus_exploration.py", ("artifacts/corpus_objectives/objective_validation_report.md",), "Can candidates be generated and scored?", "C06", "v1 complete", "Closed-loop QD hardening remains future work."),
    ArtifactManifestEntry("artifacts/generic_corpus_exploration/archive_coverage_heatmap.png", "src/kinematic_classifier_sandbox/generic_corpus_exploration.py", ("artifacts/generic_corpus_exploration/archive_cells.csv",), "Does the corpus explorer cover archive cells?", "C06", "v1 complete", "Archive dimensions are still 1D-oriented."),
    ...
    ArtifactManifestEntry("artifacts/corpus_adequacy_audit_v1/corpus_adequacy_scorecard.csv", "src/kinematic_classifier_sandbox/corpus_adequacy_audit.py", ("artifacts/common_1d_classifier_study/dataset_manifest.json",), "Does the corpus pass adequacy gates before classifier claims?", "C01", "strong", "Some generated corpora still require hardening."),
    ArtifactManifestEntry("artifacts/corpus_adequacy_audit_v1/covariate_leakage_audit.csv", "src/kinematic_classifier_sandbox/corpus_adequacy_audit.py", ("artifacts/common_1d_classifier_study/dataset_manifest.json",), "Are there corpus shortcuts or leakage risks?", "C01", "strong", "Leakage checks are only as complete as the recorded covariates."),
    ArtifactManifestEntry("artifacts/class_validity/class_validity_scores.csv", "src/kinematic_classifier_sandbox/class_validity.py", ("artifacts/class_validity/class_definition_schema.json",), "Are class definitions internally valid?", "C01", "implemented", "Class validity scores do not replace domain review."),
    ArtifactManifestEntry("artifacts/feature_analysis_v1/feature_separation_scores.csv", "src/kinematic_classifier_sandbox/feature_analysis.py", ("artifacts/feature_analysis_v1/feature_matrix.csv",), "Are classes separable under the current feature set?", "C02", "strong", "Static separability does not prove independent evidence."),
    ArtifactManifestEntry("artifacts/feature_analysis_v1/pairwise_auc_matrix.csv", "src/kinematic_classifier_sandbox/feature_analysis.py", ("artifacts/feature_analysis_v1/feature_matrix.csv",), "Which class pairs are separable by feature?", "C02", "strong", "Pairwise separability can hide multiclass interactions."),
    ArtifactManifestEntry("artifacts/feature_analysis_v1/pairwise_overlap_heatmap.png", "src/kinematic_classifier_sandbox/feature_analysis.py", ("artifacts/feature_analysis_v1/pairwise_overlap_matrix.csv",), "Where do feature distributions overlap?", "C02", "strong", "Overlap depends on the sampled corpus."),
    ArtifactManifestEntry("artifacts/prior_sensitivity_pointwise_v1/prior_sensitivity.csv", "src/kinematic_classifier_sandbox/prior_sensitivity_analysis.py", ("artifacts/pointwise_baseline/posterior_history.csv",), "Do pointwise decisions flip under plausible priors?", "C03", "strong", "Prior ranges need study-specific policy."),
    ArtifactManifestEntry("artifacts/prior_sensitivity_windowed_robust_v1/prior_flip_thresholds.csv", "src/kinematic_classifier_sandbox/prior_sensitivity_analysis.py", ("artifacts/windowed_baseline/posterior_history.csv",), "Where do robust windowed decisions flip?", "C03", "strong", "Robust features still inherit window-dependence assumptions."),
    ...
    ArtifactManifestEntry("artifacts/repo_story/witness_problem_matrix.csv", "src/kinematic_classifier_sandbox/repo_story.py", ("docs/witnesses/index.md",), "Which witness proves which methodology layer?", "C05", "canonical", "Witnesses are 1D."),
    ArtifactManifestEntry("artifacts/pointwise_baseline/pointwise_baseline_diagnostics.png", "src/kinematic_classifier_sandbox/pointwise_baseline.py", ("artifacts/pointwise_baseline/posterior_history.csv",), "Does the pointwise witness expose likelihood and posterior behavior?", "C05", "promote", "No history or dynamics evidence."),
    ArtifactManifestEntry("artifacts/windowed_baseline/windowed_baseline_diagnostics.png", "src/kinematic_classifier_sandbox/windowed_baseline.py", ("artifacts/windowed_baseline/feature_matrix.csv",), "Does the windowed witness expose raw versus robust feature behavior?", "C05", "revise/promote by case", "Overlapping windows can double-count evidence if misinterpreted."),
    ArtifactManifestEntry("artifacts/bayes_accumulator/bayes_accumulator_diagnostics.png", "src/kinematic_classifier_sandbox/sequential_bayes_accumulator.py", ("artifacts/bayes_accumulator/posterior_history.csv",), "Does sequential history improve evidence over time?", "C05", "promote", "Does not model dynamics residuals."),
    ArtifactManifestEntry("artifacts/kalman_filter_bank/kalman_bank_diagnostics.png", "src/kinematic_classifier_sandbox/kalman_filter_bank.py", ("artifacts/kalman_filter_bank/innovation_history.csv",), "Can innovation likelihoods serve as class evidence?", "C05", "promote", "Does not prove general nonlinear 3D performance."),
    ArtifactManifestEntry("artifacts/transition_matrix_accumulator_v1/transition_matrix_diagnostics.png", "src/kinematic_classifier_sandbox/transition_matrix_accumulator.py", ("artifacts/transition_matrix_accumulator_v1/transition_matrix_posterior_history.csv",), "Does transition logic address static-class switching failures?", "C05", "pass", "Transition logic is now a baseline for IMM rather than a replacement."),
    ArtifactManifestEntry("artifacts/advanced_filter_comparison_v1/advanced_filter_decision_matrix.csv", "src/kinematic_classifier_sandbox/advanced_filters/evaluation.py", ("artifacts/imm_filter_v1/switching_detection_metrics.csv", "artifacts/particle_filter_v1/pf_method_comparison.csv", "artifacts/rbpf_v1/rbpf_method_comparison.csv"), "Which advanced filters promote on targeted witness failures?", "C07", "implemented", "Promotions are current-witness claims, not universal dominance claims."),
    ArtifactManifestEntry("artifacts/dimensional_lift_audit/module_dimension_status.csv", "src/kinematic_classifier_sandbox/dimensional_lift_audit.py", ("src/kinematic_classifier_sandbox",), "What must change for 3D transition?", "C08", "architectural", "3D adapters and dynamics are incomplete."),
    ArtifactManifestEntry("artifacts/validation_ladder/validation_ladder_decisions.csv", "src/kinematic_classifier_sandbox/validation_ladder.py", ("artifacts/validation_ladder/validation_ladder_scores.csv",), "Which studies promote, revise, reject, or defer?", "C01;C02;C03;C04", "implemented", "Promotion quality depends on upstream corpus, feature, prior, and evidence checks."),
)
...
def render_claim_evidence_markdown() -> str:
    ...
    for claim in CLAIMS:
        docs = "; ".join(f"`{path}`" for path in claim.evidence_doc)
        artifacts = "; ".join(f"`{path}`" for path in claim.artifact_paths)
        tests = "; ".join(f"`{path}`" for path in claim.test_paths)
        lines.append(
            f"| {claim.claim_id} | {claim.claim} | {claim.pillar} | {docs} | {artifacts} | {tests} | {claim.current_status} | {claim.limitations} | {claim.next_work} |"
        )
    lines.extend(
        [
            "",
...
def render_artifact_graph_markdown() -> str:
    report_rows = (
        ...
        ("artifacts/advanced_filter_comparison_v1/advanced_filter_comparison_report.md", "method_comparison.csv, advanced_filter_decision_matrix.csv, nonlinear_stress_metrics.csv, latent_maneuver_metrics.csv"),
    ...
    for entry in ARTIFACT_MANIFEST:
        lines.append(f"| `{entry.path}` | {', '.join(f'`{item}`' for item in entry.depends_on)} |")
    lines.extend(["", "## Reports And Their Tables", "", "| Report | Primary tables / structured inputs |", "| --- | --- |"])
    for report, tables in report_rows:
        lines.append(f"| `{report}` | {tables} |")
    lines.extend(["", "## Plots Supporting Claims", "", "| Claim | Plot |", "| --- | --- |"])
    for claim in CLAIMS:
        lines.append(f"| {claim.claim_id} {claim.claim} | `{claim.showcase_plot}` |")
    lines.extend(
        [
            "",
...
def render_artifact_index_markdown() -> str:
    ...
    lines = [
        "# Artifact Index",
        "",
        "This is the human-readable view of `artifact_manifest.json`. It is generated from the repo-story manifest.",
    ]
    for title, claim_ids in sections:
        lines.extend(["", f"## {title}", "", "| Artifact | Question answered | Claim |", "| --- | --- | --- |"])
        for entry in ARTIFACT_MANIFEST:
            if entry.claim_supported in claim_ids:
                lines.append(f"| `{entry.path}` | {entry.question_answered} | {entry.claim_supported} |")
    lines.extend(
        [
            "",
...
def render_proof_gallery() -> str:
    lines = ["# Proof Gallery", "", "This gallery is generated from the canonical PLN-024 claim matrix."]
    for index, claim in enumerate(CLAIMS, start=1):
        lines.extend(
            [
                ...
                "",
                f"Supporting plot: [{claim.showcase_plot}]({claim.showcase_plot})",
                "",
                f"Supporting table: [{claim.showcase_table}]({claim.showcase_table})",
                "",
                f"Supporting artifact: `{claim.artifact_paths[0]}`",
                "",
...
def render_story_index() -> str:
    lines = ["# Claim-Oriented Showcase Index", "", "Use this as the team-facing showcase front door."]
    for index, claim in enumerate(CLAIMS, start=1):
        lines.extend(
            [
                "",
                f"{index}. {claim.claim}",
                f"   - `{claim.showcase_plot}`",
                f"   - `{claim.showcase_table}`",
                f"   - `{claim.artifact_paths[0]}`",
            ]
        )
    return "\n".join(lines)
...
def render_team_packet_index() -> str:
    ...
    return f"""# Team Packet

This packet should be readable without opening source code. The repo is a methodology workbench for kinematic classification studies, currently proven through 1D witness problems.

## Front Door

1. `docs/story/00_repo_story.md`
2. `docs/story/01_methodology_map.md`
3. `docs/story/02_reading_order.md`
4. `artifacts/showcase/story_index.md`
5. `artifacts/repo_story/claim_evidence_matrix.csv`

## Headline Products

1. Study Candidate Evaluator: Feature + Class + Classifier/Filter + Prior evaluation.
2. Corpus Explorer: objective-driven corpus generation, search, adequacy, leakage, and class-validity evaluation.
3. 1D Witness Suite: controlled problems that prove methodology layers before 3D.
...
def render_status_report() -> str:
    return f"""# PLN-024 Status Report
...
- Manifest audit: `artifact_manifest.json` has {len(ARTIFACT_MANIFEST)} entries and every entry includes path, generator, dependencies, question, claim, status, and limitation.
- Witness audit: every witness card links to at least one plot and one table through `witness_problem_matrix.csv`.
- Regression evidence: run `PYTHONPYCACHEPREFIX=/Users/rick/LocalStorage/GIT_LOCAL/active/CACHE/kinematic-classifier-sandbox/.pycache MPLCONFIGDIR=/private/tmp/kinematic-classifier-sandbox-mpl python3 scripts/all.py`.

## Top 10 Review Artifacts

1. `docs/story/00_repo_story.md`
2. `docs/story/01_methodology_map.md`
3. `docs/story/02_reading_order.md`
4. `docs/story/study_candidate_evaluator.md`
5. `docs/story/corpus_explorer.md`
6. `docs/story/algorithm_ladder.md`
7. `docs/story/how_to_interpret_results.md`
8. `docs/witnesses/index.md`
9. `artifacts/repo_story/claim_evidence_matrix.csv`
10. `artifacts/showcase/proof_gallery.md`

## Stale Or Duplicate Docs Found
...
def render_repo_story_index() -> str:
    return """# Repo Story Artifact Index
...
def render_top_20_artifacts() -> str:
    ...
    lines = ["# Top 20 Story Artifacts To Review", ""]
    lines.extend(f"{index}. `{entry}`" for index, entry in enumerate(entries, start=1))
    lines.extend(["", "Status and validation summary: `artifacts/repo_story/pln024_status_report.md`."])
    return "\n".join(lines)
...
def write_repo_story_artifacts(
    ...
    *,
    ...
    _write_csv(run_dir / "study_candidate_evaluator_summary.csv", [
    ...
    _write_csv(run_dir / "corpus_explorer_summary.csv", [
