...
CAPABILITY_SPECS: tuple[CorpusEvaluationCapabilitySpec, ...] = (
    CorpusEvaluationCapabilitySpec(
        ...
        artifact_module="kinematic_classifier_sandbox.corpus.adequacy_audit",
    ...
    CorpusEvaluationCapabilitySpec(
        ...
        artifact_module="kinematic_classifier_sandbox.analysis.feature_analysis",
    ...
    CorpusEvaluationCapabilitySpec(
        ...
        artifact_module="kinematic_classifier_sandbox.corpus.selected_generated_corpus",
    ...
    CorpusEvaluationCapabilitySpec(
        ...
        artifact_module="kinematic_classifier_sandbox.corpus.coverage_report",
