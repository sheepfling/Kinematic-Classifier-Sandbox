...
FUNCTIONAL_SURFACE_REGISTRY: tuple[FunctionalSurfaceSpec, ...] = (
    ...
    FunctionalSurfaceSpec(
        ...
        artifact_outputs=("view_summary.csv", "embedding_summary.csv", "prediction_summary.csv", "metric_summary.csv", "accuracy_bars.png"),
        evaluation_mode="analysis_plus_artifact_shell",
        showcase_priority="high",
        notes="First TS2Vec-style embedding witness packet with a shared 1D dynamics corpus and downstream embedding heads.",
    ),
    FunctionalSurfaceSpec(
    ...
    FunctionalSurfaceSpec(
        ...
        artifact_outputs=("method_specs.json", "algorithm_promotion_status_matrix.csv", "witness_to_method_coverage_matrix.csv", "lane_summary.csv"),
        evaluation_mode="registry_plus_artifact_shell",
        showcase_priority="high",
