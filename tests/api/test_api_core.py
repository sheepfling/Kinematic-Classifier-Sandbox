...
import kinematic_classifier_sandbox.api_core as api


class ApiCoreTests(unittest.TestCase):
    def test_api_exports_canonical_entry_points(self) -> None:
        self.assertTrue(hasattr(api, "analyze_common_experiment"))
        self.assertTrue(hasattr(api, "analyze_corpus_gym_contract"))
