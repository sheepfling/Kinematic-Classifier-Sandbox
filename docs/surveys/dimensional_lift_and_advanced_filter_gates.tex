...
\begin{itemize}[leftmargin=1.5em]
    ...
    numeric gate evidence for PF,
    \item \texttt{generic\_filtering\_contract.py}: required shared output
    contract for any PF or RBPF backend,
    \item \texttt{advanced\_state\_inference.py}: nearest implemented
    advanced-filter proof surface and template for posterior-compatible
    evidence/diagnostic rows.
\end{itemize}
