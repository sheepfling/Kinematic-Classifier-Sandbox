...
For the user-facing product map, start with [Three Products](story/three_products.md).
...
- Three products: Static Admissibility, the Classifier Evidence Ladder, and RL Corpus Exploration.
