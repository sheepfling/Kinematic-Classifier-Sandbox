...
nonlinear\_drag\_particle\_filter & Show nonlinear/non-Gaussian filtering beyond linear-Gaussian dynamics & Particle evidence can absorb drag and outlier behavior through sampled state histories. & Witness is targeted and does not replace simpler rungs on easy regimes. \\
