...
\begin{abstract}
This document is the corpus-side math companion to the workflow note. It focuses on how corpus candidates are proposed, scored, audited, compared, and selected before classifier claims are trusted.
\end{abstract}
