...
from kinematic_classifier_sandbox import write_functional_surface_catalog_artifacts


def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="python3 scripts/render_functional_surface_catalog.py")
    parser.add_argument(
        "--output-dir",
        default="artifacts",
